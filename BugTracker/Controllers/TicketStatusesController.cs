...
namespace BugTracker.Controllers
{
    public class TicketStatusesController : Controller
    {
        ...
        public ActionResult Details(int? id)
        {
            ...
            TicketStatus ticketStatuses = db.TicketStatuses.Find(id);
        ...
        public ActionResult Create([Bind(Include = "Id,Name")] TicketStatus ticketStatuses)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name")] TicketStatus ticketStatuses)
        {
            if (ModelState.IsValid)
            {
